(() => {
		...
		posts.forEach(post => {
			feed.innerHTML += `<li class="rv b agz">
              ...
              <div class="rw">
                ...
                <button type="button" class="close" data-id="${post._id}" for="delete-post" aria-hidden="true" title="Удалить"><span class="h bbg"></span></button>
                <hr>
	...
	function deletePostListener(event) {
		...
		if (button.getAttribute('for') !== 'delete-post') {
			return;
		}
